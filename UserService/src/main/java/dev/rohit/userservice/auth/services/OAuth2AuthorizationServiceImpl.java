...
import dev.rohit.userservice.auth.models.Authorization;
import dev.rohit.userservice.auth.models.AuthorizationConsent;
import dev.rohit.userservice.auth.repositories.AuthorizationConsentRepository;
import dev.rohit.userservice.auth.repositories.AuthorizationRepository;
...
public class OAuth2AuthorizationServiceImpl implements OAuth2AuthorizationService {
    ...
    public OAuth2AuthorizationServiceImpl(AuthorizationRepository authorizationRepository, RegisteredClientRepository registeredClientRepository) {
